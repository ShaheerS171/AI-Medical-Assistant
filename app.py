...
"""
app.py - Unified FastAPI Backend for AI Medical Assistant with Supabase Auth
Exposes secured endpoints for diagnostics, consultations, and doctor discovery.
"""
