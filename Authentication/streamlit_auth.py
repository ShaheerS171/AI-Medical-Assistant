"""
streamlit_auth.py - Centered Streamlit Authentication Component for Supabase
"""
...
def render_auth_ui(location="main"):
    """
    ...
    # =========================================================================
    # USER IS LOGGED IN -> Show Profile & Sign Out Button in Sidebar
    # =========================================================================
    ...
    # =========================================================================
    # USER IS NOT LOGGED IN -> Show Centered Sign In / Sign Up Cards
    # =========================================================================
    col_left, col_center, col_right = st.columns([1, 2, 1])

    with col_center:
        st.markdown("<h2 style='text-align: center; margin-bottom: 0px;'>🏥 AI Medical Assistant</h2>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center; color: #64748B; margin-bottom: 2rem;'>Clinical Diagnostics & Triage Decision Support Platform</p>", unsafe_allow_html=True)
        ...
        with tab_signup:
            with st.form("form_signup"):
                ...
                email_up = st.text_input("Work Email Address", placeholder="doctor@hospital.org")
